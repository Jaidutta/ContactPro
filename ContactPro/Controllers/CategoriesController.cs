...
namespace ContactPro.Controllers
{
    public class CategoriesController : Controller
    {
        ...
        {  // EmailCategory takes in the category id as input parameters
            string appUserId = _userManager.GetUserId(User);
        ...
        {   
                ...
                try
                {
                    ...
                    return RedirectToAction("Index", "Categories", new { swalMessage = "Success: Email Sent Successfully!" });
                }
                catch
                {

                    return RedirectToAction("Index", "Categories", new { swalMessage = "Error: It failed to send the email!" });
                    throw;
                }
